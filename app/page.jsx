import TestimonialCarsouel from "@/components/testimonialCarsouel";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <p className="text-lg md:text-xl text-orange-800 mb-8">
          Capture your thoughts, tack your moods, and reflect on your journey in
      ...
      <section
        id="features"
        className="mt-24 grid md:grid-cols-2 lg:grid-cols-3 gap-8 px-10"
      >
      ...
      <div className="space-y-24 mt-24 px-10">
      ...
      <div className="mt-24 p-5">
        ...
        {faqs.map((item, index) => {
          return (
            <>
              <Accordion type="multiple" collapsible className="w-full mx-auto">
        ...
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-lg text-orange-700 mb-8 max-w-2xl mx-auto">
              join thousands of writer who have already discovered the power of
              digital journaling.
            </p>
            <Link href="/dashboard">
              <Button size="lg" variant="journal" className="animate-bounce">
                Get Started for Free <ChevronRight className="ml-2 w-4 h-4" />
              </Button>
            </Link>
          </CardContent>
        </Card>
